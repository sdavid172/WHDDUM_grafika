...
void update_app(App* app)
{
    ...
    update_scene(&(app->scene));
     if(app->scene.car.pos.x > 2.88)
    {
        set_car_speedx(&(app->scene.car), 0);
        set_car_speedy(&(app->scene.car), 1);
        set_car_rotz(&(app->scene.car),1.0);
        set_car_angle(&(app->scene.car),270.0);
        
     
    }
    
    if(app->scene.car.pos.y < -2.82)
    {
        set_car_speedx(&(app->scene.car),-1);
        set_car_speedy(&(app->scene.car),0);
        set_car_rotz(&(app->scene.car),1.0);
        set_car_angle(&(app->scene.car),180.0);
         
    
    }

    if(app->scene.car.pos.x < -2.89)
    {
        
        set_car_speedx(&(app->scene.car), 0);
        set_car_speedy(&(app->scene.car), -1);
        set_car_rotz(&(app->scene.car),1.0);
        set_car_angle(&(app->scene.car),90.0);
         
     
    }

    if(app->scene.car.pos.y > 2.5)
    {
